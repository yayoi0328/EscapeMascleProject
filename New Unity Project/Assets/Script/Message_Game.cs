...
public class Message_Game : MonoBehaviour
{
    ...
    void Start()
    { 
        GameObject.Find("CanvasUI").GetComponent<Canvas>().transform.GetChild(0).gameObject.SetActive(false);
        GameObject.Find("CanvasUI").GetComponent<Canvas>().transform.GetChild(1).gameObject.SetActive(false);
        ...
        else
        {
            ...
            if (Input.GetMouseButtonDown(0))
            {
                ...
                if (messageNum >= splitMessage.Length)
                {
                    ...
                    GameObject.Find("CanvasUI").GetComponent<Canvas>().transform.GetChild(0).gameObject.SetActive(true);
                    GameObject.Find("CanvasUI").GetComponent<Canvas>().transform.GetChild(1).gameObject.SetActive(true);
                }
            }
        }
    }
